...
CKEDITOR.lang.ru = {dir:'ltr',
	...
	common: {
		...
		imageButton: 'Вставить изображение',
		notSet: '<не указано>',
		id: 'Идентификатор',
		name: 'Имя',
		...
		targetSelf: 'Текущее окно (_self)',		targetParent: 'Родительское окно (_parent)',
	...
	scayt: {
		...
		dic_delete: 'Удалить',		dic_rename: 'Переименовать',
