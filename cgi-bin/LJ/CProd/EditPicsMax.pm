...
sub render {
    ...
    my $link = $class->clickthru_link('cprod.editpicsmax.link', $version);
    my $link2 = BML::ml('cprod.editpicsmax.link2-3.v'.$version, { aopts => "href='$LJ::SITEROOT/manage/payments/'" });
    my $link3 = BML::ml('cprod.editpicsmax.link3.v'.$version, { aopts => "href='$LJ::SITEROOT/shop/view.bml?item=userpics'" });
...
sub ml { 'cprod.editpicsmax.text5' }
