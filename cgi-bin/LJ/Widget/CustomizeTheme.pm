...
sub render_body {
    ...
    if ($print_style_header) {
        $ret .= "<li" . $nav_class->("style") . "><a class='customize-nav-group' href='$LJ::SITEROOT/customize2/options.bml$getextra${getsep}group=style'>" . $class->ml('widget.customizetheme.nav.style') . "</a>";
        $ret .= "<ul>";
    ...
    foreach my $g (@$group_names) {
        ...
        my $name = LJ::Customize->propgroup_name($g, $u, $style);
        $ret .= "<li" . $nav_class->($g) . "><a class='customize-nav-group' href='$LJ::SITEROOT/customize2/options.bml$getextra${getsep}group=$g'>$name</a></li>";
    }

    $ret .= "<li" . $nav_class->("linkslist") . "><a class='customize-nav-group' href='$LJ::SITEROOT/customize2/options.bml$getextra${getsep}group=linkslist'>" . $class->ml('widget.customizetheme.nav.linkslist') . "</a></li>";

    if ($has_group{customcss}) {
        my $name = LJ::Customize->propgroup_name("customcss", $u, $style);
        $ret .= "<li" . $nav_class->("customcss") . "><a class='customize-nav-group' href='$LJ::SITEROOT/customize2/options.bml$getextra${getsep}group=customcss'>$name</a></li>";
    }
