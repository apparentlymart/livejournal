...
sub add       { (defined $_[1]) ? $memc->add(@_)    : $memc->add($_[0],     '', $_[2]) }
sub replace   { (defined $_[1]) ? $memc->replace(@_): $memc->replace($_[0], '', $_[2]) }
sub set       { (defined $_[1]) ? $memc->set(@_)    : $memc->set($_[0],     '', $_[2]) }
