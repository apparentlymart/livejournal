...
sub handle_unmapped {
    ...
    if ($body_text  =~ /^\s*help/i) {
        my $help_text = "In order to use $LJ::SMS_TITLE please visit $LJ::SITEROOT/sms/ to set up your account. For help contact support\@livejournal.com or 415-294-5054.";
        my $gw =  LJ::sms_gateway()
