    ...
    while (my $token = $p->get_token)
    {
        ...
        if ($type eq "S")     # start tag
        {
            ...
            if ( $tag eq 'lj-spoiler' ) {
                ...
                $newdata .= qq{<div class="lj-spoiler"><div class="lj-spoiler-head">[<b><a href="#">$title</a></b>]</div><div class="lj-spoiler-body">};
                $ljspoilers_open++;
                next TOKEN;
            }
            ...
            if (($tag eq "lj-cut" || $ljcut_div)) {
                ...
                if ($cut) {
                    ...
                    $newdata .= qq|<b class="ljcut-link">&#9986;&middot;&middot;&middot;<a href="$url#cutid$cutcount">$etext</a>&middot;&middot;&middot;</b>|;
                    $newdata .= "</div>" if $tag eq "div";
