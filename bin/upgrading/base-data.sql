...
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, multihomed, name, prettyname, scope) VALUES ('4', 'bool', 'LJCUT disabled in lastn and day views', '1', '0', 'opt_ljcut_disable_lastn', 'LJCUT disabled in lastn view', 'general');
UPDATE userproplist SET cldversion='4',datatype='bool',des='LJCUT disabled in lastn view',indexed='1',multihomed='0',prettyname='LJCUT disabled in lastn and day views',scope='general' WHERE name='opt_ljcut_disable_lastn';
