...
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, multihomed, name, prettyname, scope) VALUES ('0', 'char', 'Location of External FOAF file', '1', '0', 'external_foaf_url', 'FOAF address', 'general');
UPDATE userproplist SET cldversion='0',datatype='char',des='Location of External FOAF file',indexed='1',multihomed='0',prettyname='FOAF address',scope='general' WHERE name='external_foaf_url';
...
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, multihomed, name, prettyname, scope) VALUES ('4', 'char', 'Comma separated:  Unix time user agreed to the Terms of Service, revision number', '0', '0', 'legal_tosagree', 'Agreed to Terms of Service', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='Comma separated:  Unix time user agreed to the Terms of Service, revision number',indexed='0',multihomed='0',prettyname='Agreed to Terms of Service',scope='general' WHERE name='legal_tosagree';
...
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, multihomed, name, prettyname, scope) VALUES ('4', 'bool', 'LJCUT disabled in lastn view', '1', '0', 'opt_ljcut_disable_lastn', 'LJCUT disabled in lastn view', 'general');
UPDATE userproplist SET cldversion='4',datatype='bool',des='LJCUT disabled in lastn view',indexed='1',multihomed='0',prettyname='LJCUT disabled in lastn view',scope='general' WHERE name='opt_ljcut_disable_lastn';
...
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, multihomed, name, prettyname, scope) VALUES ('4', 'bool', 'Boolean: 1 means show only mutual friends on your userinfo page, 0 (default) means to use the standard mode of showing everybody.', '1', '0', 'opt_onlymutualfriends', 'Mutual Friends Display', 'general');
UPDATE userproplist SET cldversion='4',datatype='bool',des='Boolean: 1 means show only mutual friends on your userinfo page, 0 (default) means to use the standard mode of showing everybody.',indexed='1',multihomed='0',prettyname='Mutual Friends Display',scope='general' WHERE name='opt_onlymutualfriends';
...
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, multihomed, name, prettyname, scope) VALUES ('4', 'bool', 'Boolean: 1 means show only mutual friends on your userinfo page, 0 (default) means to use the standard mode of showing everybody.', '1', '0', 'show_mutual_friends', 'Mutual Friends Display', 'general');
UPDATE userproplist SET cldversion='4',datatype='bool',des='Boolean: 1 means show only mutual friends on your userinfo page, 0 (default) means to use the standard mode of showing everybody.',indexed='1',multihomed='0',prettyname='Mutual Friends Display',scope='general' WHERE name='show_mutual_friends';
