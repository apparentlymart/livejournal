...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Allows a user to view information that isn\'t otherwise available.  Arg="suspended": can view public posts in a suspended journal, Arg="*": can view everything, Arg="styles": can see private styles.  All use is logged.', '0', 'canview', 'View All Entries', 'general');
UPDATE priv_list SET des='Allows a user to view information that isn\'t otherwise available.  Arg="suspended": can view public posts in a suspended journal, Arg="*": can view everything, Arg="styles": can see private styles.  All use is logged.',is_public='0',privname='View All Entries',scope='general' WHERE privcode='canview';
...
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, name, prettyname, scope) VALUES ('0', 'num', 'The ID of the blob cluster user\'s media resides on.', '1', 'blob_clusterid', 'Blob Cluster ID', 'general');
UPDATE userproplist SET cldversion='0',datatype='num',des='The ID of the blob cluster user\'s media resides on.',indexed='1',prettyname='Blob Cluster ID',scope='general' WHERE name='blob_clusterid';
...
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, name, prettyname, scope) VALUES ('4', 'char', 'Comma separated list of email addresses allowed to send mail via gateway', '0', 'emailpost_allowfrom', 'Allowed addresses to post via email', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='Comma separated list of email addresses allowed to send mail via gateway',indexed='0',prettyname='Allowed addresses to post via email',scope='general' WHERE name='emailpost_allowfrom';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, name, prettyname, scope) VALUES ('4', 'char', 'Numeric or alpha PIN used for posting via email gateway', '0', 'emailpost_pin', 'PIN for email posting', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='Numeric or alpha PIN used for posting via email gateway',indexed='0',prettyname='PIN for email posting',scope='general' WHERE name='emailpost_pin';
...
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, name, prettyname, scope) VALUES ('4', 'char', 'N = send no email, D = send daily digest, else send email always.', '0', 'opt_communityjoinemail', 'Get Emails for Join Requests', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='N = send no email, D = send daily digest, else send email always.',indexed='0',prettyname='Get Emails for Join Requests',scope='general' WHERE name='opt_communityjoinemail';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, name, prettyname, scope) VALUES ('4', 'char', '1 = send poster comments they make, else don\'t.', '0', 'opt_getselfemail', 'Get Emails for Comments You Make', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='1 = send poster comments they make, else don\'t.',indexed='0',prettyname='Get Emails for Comments You Make',scope='general' WHERE name='opt_getselfemail';
...
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, name, prettyname, scope) VALUES ('4', 'char', 'width|height: specifies maximum image size on a user\'s friends page.  0 for either field replaces all images.', '0', 'opt_imagelinks', 'Use Placeholders on Your Friend\'s Page', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='width|height: specifies maximum image size on a user\'s friends page.  0 for either field replaces all images.',indexed='0',prettyname='Use Placeholders on Your Friend\'s Page',scope='general' WHERE name='opt_imagelinks';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, name, prettyname, scope) VALUES ('4', 'bool', 'LJCUT disabled in friends view', '1', 'opt_ljcut_disable_friends', 'LJCUT disabled in friends view', 'general');
UPDATE userproplist SET cldversion='4',datatype='bool',des='LJCUT disabled in friends view',indexed='1',prettyname='LJCUT disabled in friends view',scope='general' WHERE name='opt_ljcut_disable_friends';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, name, prettyname, scope) VALUES ('4', 'bool', 'LJCUT disabled in lastn view', '1', 'opt_ljcut_disable_lastn', 'LJCUT disabled in lastn view', 'general');
UPDATE userproplist SET cldversion='4',datatype='bool',des='LJCUT disabled in lastn view',indexed='1',prettyname='LJCUT disabled in lastn view',scope='general' WHERE name='opt_ljcut_disable_lastn';
...
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, name, prettyname, scope) VALUES ('4', 'bool', 'Boolean: 1 means show only mutual friends on your userinfo page, 0 (default) means to use the standard mode of showing everybody.', '1', 'opt_showmutualfriends', 'Mutual Friends Display', 'general');
UPDATE userproplist SET cldversion='4',datatype='bool',des='Boolean: 1 means show only mutual friends on your userinfo page, 0 (default) means to use the standard mode of showing everybody.',indexed='1',prettyname='Mutual Friends Display',scope='general' WHERE name='opt_showmutualfriends';
...
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, name, prettyname, scope) VALUES ('4', 'bool', '1: use journal style when commenting on other journals from friends page', '0', 'opt_stylemine', 'Style=Mine', 'general');
UPDATE userproplist SET cldversion='4',datatype='bool',des='1: use journal style when commenting on other journals from friends page',indexed='0',prettyname='Style=Mine',scope='general' WHERE name='opt_stylemine';
...
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, name, prettyname, scope) VALUES ('4', 'blobchar', 'Public key used for email gateway signature verification', '0', 'public_key', 'PGP or GPG public key', 'general');
UPDATE userproplist SET cldversion='4',datatype='blobchar',des='Public key used for email gateway signature verification',indexed='0',prettyname='PGP or GPG public key',scope='general' WHERE name='public_key';
