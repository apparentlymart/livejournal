...
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, multihomed, name, prettyname, scope) VALUES ('4', 'char', 'community promo blurb', '0', '0', 'comm_promo_blurb', 'A short description of a community that is displayed in the', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='community promo blurb',indexed='0',multihomed='0',prettyname='A short description of a community that is displayed in the',scope='general' WHERE name='comm_promo_blurb';
...
UPDATE userproplist SET cldversion='4',datatype='bool',des='set to force disable of community promo',indexed='0',multihomed='0',prettyname='Administratively disable community promo features for a user',scope='general' WHERE name='disable_comm_promo';
...
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, multihomed, name, prettyname, scope) VALUES ('4', 'bool', 'set to force disable of community promo', '0', '0', 'opt_comm_promo', 'Administratively disable community promo features', 'general');
