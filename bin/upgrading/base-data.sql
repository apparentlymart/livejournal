...
INSERT IGNORE INTO logproplist (datatype, des, name, prettyname, scope, sortorder) VALUES ('bool', 'Set to true if this item shouldn\'t show up on people\'s friends lists (because it occured in the past)', 'opt_backdated', 'Back-dated', 'general', '35');
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('If a user has this priv, they can access new features that are under development arg=Feature codename being developed', '1', 'betatest', 'Beta Test Features', 'general');
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Change a user\'s journal type without being them.', '1', 'changejournaltype', 'Change Journal Type', 'general');
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Can change the maintainer of a community', '', 'communityxfer', 'Community Maintainer Transfer', 'general');
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Delete comments from journals (only used in rare cases, like people posting other user\'s phone numbers to be mean', '1', 'deletetalk', 'Delete Comments', 'general');
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Users with this priv can FTP files and have them copied over to the main site\'s document roots. An example argument would be: "client/win32=files/bin/clients/win32".  arg=Unique path of the form "devftppath=htdocpath"', '1', 'dirsync', 'Directory Sync', 'general');
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Allows a user to add documents to the Frequently Asked Questions. arg=Unique faq category code that the privilege is applicable for, or "all" for all faq categories.', '1', 'faqadd', 'FAQ - Add', 'general');
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Lets user modify FAQ categories.', '1', 'faqcat', 'FAQ - Edit Categories', 'general');
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Allows a user to edit documents in the Frequently Asked Questions. arg=Unique FAQ category code that the privilege is applicable for, or "all" for all faq categories', '1', 'faqedit', 'FAQ - Edit', 'general');
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Allows a user to edit a static file in the main site\'s document include tree. arg=Unique file identifier, or "all" for all files', '1', 'fileedit', 'File Editing', 'general');
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Can give another user a permanent account', '1', 'grantperm', 'Grant Permanent Account', 'general');
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Allows a user to view data in the "statushistory" table for all users. If arg is "all", can query by adminid also. arg=Optional "all", which allows extended queries.', '1', 'historyview', 'View statushistory info', 'general');
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Records payments for paid accounts', '1', 'moneyenter', 'Money - Enter Payments', 'general');
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Search for payments entered.', '1', 'moneysearch', 'Money - Search for payments', 'general');
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('See details about incoming money.', '1', 'moneyview', 'Money - View Detailed Records', 'general');
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Different arguments of this priv allows users to view/adjust certain critical site settings. arg=Unique keyword that user has access to view', '1', 'siteadmin', 'Administer Site', 'general');
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Delete duplicate or fake support requests.', '1', 'supportdelete', 'Support - Delete Requests', 'general');
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Grants a user access to reply to people\'s support requests. arg=Unique support category where user has permission to help.', '1', 'supporthelp', 'Support - Help people', 'general');
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Grants a user the ability to make internal comments on support requests. arg=Unique support category where user has permission to make internal comments.', '1', 'supportmakeinternal', 'Support - Make Internal Comments', 'general');
UPDATE priv_list SET is_public='1',des='Grants a user the ability to make internal comments on support requests. arg=Unique support category where user has permission to make internal comments.',scope='general',privname='Support - Make Internal Comments' WHERE privcode='supportmakeinternal';
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Grants a user the ability to move support requests to different catagories and to mark requests as still needing help. The supportmakeinternal priv is required. arg=Unique support category where user has permission to move support catagories from or touch', '1', 'supportmovetouch', 'Support - Move and Touch Requests', 'general');
UPDATE priv_list SET is_public='1',des='Grants a user the ability to move support requests to different catagories and to mark requests as still needing help. The supportmakeinternal priv is required. arg=Unique support category where user has permission to move support catagories from or touch',scope='general',privname='Support - Move and Touch Requests' WHERE privcode='supportmovetouch';
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Grants a user access to read people\'s support requests in certain categories. arg=Unique support category where user has permission to read requests.', '1', 'supportread', 'Support - Read Requests', 'general');
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Grants a user the ability to view internal comments on support requests. arg=Unique support category where user has permission to view internal comments.', '1', 'supportviewinternal', 'Support - View Internal Comments', 'general');
UPDATE priv_list SET is_public='1',des='Grants a user the ability to view internal comments on support requests. arg=Unique support category where user has permission to view internal comments.',scope='general',privname='Support - View Internal Comments' WHERE privcode='supportviewinternal';
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Grants a user the ability to read screened answers on support requests. arg=Unique support category where user has permission to read screened answers.', '1', 'supportviewscreened', 'Support - See Screened Answers', 'general');
UPDATE priv_list SET is_public='1',des='Grants a user the ability to read screened answers on support requests. arg=Unique support category where user has permission to read screened answers.',scope='general',privname='Support - See Screened Answers' WHERE privcode='supportviewscreened';
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Allows a user to approve or deny entries that are submitted to the directory. arg=Unique category number that the user has access in, or "all" for all categories', '1', 'topicscreencat', 'Topic Dir - Screen Submissions', 'general');
...
REPLACE INTO schemacols (colname, des, tablename) VALUES ('A URL string of arguments.', 'cmdbuffer', 'args');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('A bitmask ... bit 0 is for all friends.', 'log', 'allowmask');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('A bitmask of 1 (1 << 0) OR\'ed with (1 <<', 'friends', 'groupmask');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('A description of how that color code is', 'themecoltypes', 'des');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('A description of the table, for use in t', 'schematables', 'des');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('A unique name of the server.', 'dbinfo', 'name');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Account code ID.  Primary key.', 'acctcode', 'acid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('An MD5sum of the SQL search query.', 'dirsearchres2', 'qdigest');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('An integer specifying the order the colo', 'themecoltypes', 'sortorder');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Can people join without being invited?', 'community', 'membership');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('City name', 'zip', 'city');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Client string, of form Platform-Name/Ver', 'clients', 'client');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Clientid of client from [dbtable[clients', 'clientusage', 'clientid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Community\'s userid from the [dbtable[use', 'community', 'userid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Date code was create.', 'acctinvite', 'dateadd');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Date the auth code was created.', 'authactions', 'datecreate');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Description of the meta-data, for use by', 'userproplist', 'des');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Determines if data from this table is ma', 'schematables', 'redist_mode');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Determines if the group can be seen by a', 'friendgroup', 'is_public');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Each comment\'s unique id.', 'talk', 'talkid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Either "N" or "Y", depending on whether', 'log', 'compressed');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Either "char" for text data, "num" for a', 'userproplist', 'datatype');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('FIPS', '??', 'zips');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Five randomly generated bytes.  This, al', 'acctcode', 'auth');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('For type "L", the log itemid.  For type', 'talk', 'nodeid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('If set to 1, users can view the data in', 'schematables', 'public_browsable');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('If the police or a court has contact us', 'user', 'track');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Itemid of their last post (see [dbtable[', 'userusage', 'lastitemid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Journal entry subject.  Also duplicated', 'logtext', 'subject');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Journal entry text.', 'logtext', 'event');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Journal id the command affects. This is', 'cmdbuffer', 'journalid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Latitude', 'zips', 'lat');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('List of matched userids for the query, c', 'dirsearchres2', 'userids');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Longitude', 'zips', 'lon');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Mixed case pretty name with spaces and p', 'userproplist', 'prettyname');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Name given to the friend group.', 'friendgroup', 'groupname');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Name of city', 'zips', 'Name');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Name of property, matching [a-z0-9_]+.', 'userproplist', 'name');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Name', 'Name of city', 'zips');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Number of bytes item takes up.', 'dudata', 'bytes');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Optional argument to accompany the actio', 'authactions', 'arg1');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Optional note space.', 'infohistory', 'other');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Population in 1990.', 'zips', 'pop1990');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Primary key for each authaction.', 'authactions', 'aaid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Primary key.  Auto-generated for each ne', 'clients', 'clientid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Random characters (the confirmation bit)', 'authactions', 'authcode');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Realm ID.  If you don\'t need it (most do', 'duplock', 'reid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Reason code for generating invite code.', 'acctinvite', 'reason');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Short name of the item being changed.', 'infohistory', 'what');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('State code (see [dbtable[codes]] for how', 'zip', 'state');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('State', 'State', 'zips');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('State', 'zips', 'State');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Table to lock to do this query.  Note:', 'querybuffer', 'tablename');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Text of the command name.', 'cmdbuffer', 'cmd');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The #rrggbb color (or one of the constan', 'themedata', 'color');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The DBI connection DSN, username, then p', 'dbinfo', 'fdsn');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The [dbtable[user]] userid of the bannee', 'ban', 'banneduserid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The [dbtable[user]] userid of the banner', 'ban', 'userid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The [dbtable[user]] userid of the journa', 'log', 'ownerid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The [dbtable[user]] userid of the person', 'log', 'posterid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The [dbtable[user]].userid of the friend', 'friends', 'friendid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The account code ID from [dbtable[acctco', 'acctpay', 'acid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The action command name to be run when t', 'authactions', 'action');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The answer text, in plaintext.', 'faq', 'answer');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The area of the site the lock is being p', 'duplock', 'realm');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The background color used in the friends', 'friends', 'bgcolor');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The color code name.', 'themecoltypes', 'coltype');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The color code, references [dbtable[them', 'themedata', 'coltype');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The current weighting value for this dbi', 'dbweights', 'curr');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The database role type:  master, slave,', 'dbweights', 'role');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The date it was last updated.', 'includetext', 'updatetime');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The date the FAQ item was last modified.', 'faq', 'lastmodtime');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The date the search was made.', 'dirsearchres2', 'dateins');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The day of the eventtime.  Duplicated fo', 'log', 'day');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The dbid from [dbtable[dbinfo]].', 'dbweights', 'dbid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The dbid which this server replicates fr', 'dbinfo', 'masterid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The faqid of the [dbtable[faq]] item whi', 'faquses', 'faqid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The fdsn to connect as root, to do admin', 'dbinfo', 'rootfdsn');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The filename of the include file.', 'includetext', 'incname');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The foreground color used in the friends', 'friends', 'fgcolor');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The group number. Can be 1-30.', 'friendgroup', 'groupnum');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The hintid of whatever type to delete la', 'batchdelete', 'itsid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The journal entry\'s unique ID ... refere', 'logsubject', 'itemid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The md5 digest of the event.  Concatenat', 'duplock', 'digest');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The month of the eventtime.  Duplicated', 'log', 'month');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The most recent time this user used this', 'clientusage', 'lastlogin');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The name of the main category the FAQ it', 'faq', 'faqcat');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The name of the table being described.', 'schematables', 'tablename');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The normal weighting value for this dbid', 'dbweights', 'norm');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The number of people that have replied t', 'log', 'replycount');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The number of users listing the interest', 'interests', 'intcount');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The old value of the item.', 'infohistory', 'oldvalue');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The payment ID from [dbtable[payments]].', 'acctpay', 'payid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The query to be run later.', 'querybuffer', 'query');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The question text, in plaintext.', 'faq', 'question');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The resultant acid code in table [dbtabl', 'acctinvite', 'acid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The security level of the post.  "public', 'log', 'security');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The sorting number the questions are ord', 'faq', 'sortorder');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The sorting order.', 'friendgroup', 'sortorder');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The subject of the journal entry.', 'logsubject', 'subject');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The text contents of the include file.', 'includetext', 'inctext');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The text of the interest.', 'interests', 'interest');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The time of the change.', 'infohistory', 'timechange');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The time of the entry, according to the', 'log', 'eventtime');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The time of the entry, according to the', 'log', 'logtime');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The time of the viewing.', 'faquses', 'dateview');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The time the action first completed.', 'duplock', 'instime');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The time the query was buffered.  Not us', 'querybuffer', 'instime');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The time the query was buffered. Not use', 'cmdbuffer', 'instime');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The type of usage: "L" for log, "T" for', 'dudata', 'area');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The unique ID this action generated the', 'duplock', 'dupid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The unique id given to the entry.', 'log', 'itemid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The unique id number of the FAQ.', 'faq', 'faqid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The unique itemid of the journal entry.', 'logtext', 'itemid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The userid doing the action, or 0 if use', 'duplock', 'userid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The userid of the [dbtable[user]] making', 'infohistory', 'userid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The userid of the [dbtable[user]] who ad', 'friends', 'userid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The userid of the [dbtable[user]] who la', 'faq', 'lastmoduserid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The userid of the [dbtable[user]] who pr', 'community', 'ownerid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The userid of the [dbtable[user]] who th', 'friendgroup', 'userid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The userid of the remote [dbtable[user]]', 'faquses', 'userid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The userid the disk usage item belongs t', 'dudata', 'userid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('The year of the eventtime.  Duplicated f', 'log', 'year');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('This field defines what type of thing in', 'talk', 'nodetype');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Unique ID within area, or \'0\' if area ha', 'dudata', 'areaid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Unique ID, references [dbtable[themelist', 'themedata', 'themeid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Unique database ID.  Recommended to use', 'dbinfo', 'dbid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Unique id assigned to the interest.', 'interests', 'intid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Unique id for this meta-data property.', 'userproplist', 'upropid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Unused.', 'friends', 'showbydefault');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Userid of [dbtable[user]] that code was', 'acctinvite', 'userid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Userid of [dbtable[user]] using client.', 'clientusage', 'userid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Userid of [dbtable[user]] we\'re verifyin', 'authactions', 'userid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Userid of [dbtable[user]] whose journal', 'domains', 'userid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Userid of [dbtable[user]].  One row in t', 'userusage', 'userid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Userid of recipient, or 0 if code is unu', 'acctcode', 'rcptid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Userid that can give this code.', 'acctcode', 'userid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('What type of hint needs to be purged.  T', 'batchdelete', 'what');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('When the user created their journal.', 'userusage', 'timecreate');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('When the user last updated their journal', 'userusage', 'timeupdate');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('Who can post?  Members only, or a select', 'community', 'postlevel');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('ZIP Code', 'zips', 'zip');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('[dbtable[user]]-userid that used the cod', 'ibill_codes', 'userid');
...
REPLACE INTO schemacols (colname, des, tablename) VALUES ('allowmask', 'A bitmask ... bit 0 is for all friends.  bits 1-30 are used for [dbtable[friendgroup]]s. bit 31 is reserved.', 'log');
...
REPLACE INTO schemacols (colname, des, tablename) VALUES ('banneduserid', 'The [dbtable[user]] userid of the bannee.', 'ban');
...
REPLACE INTO schemacols (colname, des, tablename) VALUES ('code', 'unique code from ibill.com', 'ibill_codes');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('color', 'The #rrggbb color (or one of the constants)', 'themedata');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('coltype', 'The color code name.', 'themecoltypes');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('coltype', 'The color code, references [dbtable[themecoltypes]].', 'themedata');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('compressed', 'Either "N" or "Y", depending on whether the journal entry is compressed.  Not supported yet.  Always "N".', 'log');
...
REPLACE INTO schemacols (colname, des, tablename) VALUES ('day', 'The day of the eventtime.  Duplicated for an index.', 'log');
...
REPLACE INTO schemacols (colname, des, tablename) VALUES ('des', 'A description of how that color code is used.', 'themecoltypes');
...
REPLACE INTO schemacols (colname, des, tablename) VALUES ('domain name, without any leading http://', 'domains', 'domain');
...
REPLACE INTO schemacols (colname, des, tablename) VALUES ('event', 'Journal entry text.', 'logtext');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('eventtime', 'The time of the entry, according to the user\'s system clock.', 'log');
...
REPLACE INTO schemacols (colname, des, tablename) VALUES ('ibid', 'unique id', 'ibill_codes');
...
REPLACE INTO schemacols (colname, des, tablename) VALUES ('instime', 'The time the query was buffered.  Not used by applications, but useful for debugging/humans.', 'querybuffer');
...
REPLACE INTO schemacols (colname, des, tablename) VALUES ('logtime', 'The time of the entry, according to the server\'s clock.', 'log');
...
REPLACE INTO schemacols (colname, des, tablename) VALUES ('month', 'The month of the eventtime.  Duplicated for an index.', 'log');
...
REPLACE INTO schemacols (colname, des, tablename) VALUES ('nodeid', 'For type "L", the log itemid.  For type "T", the todo todoid.', 'talk');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('nodetype', 'This field defines what type of thing in comment is in reply to.  Values can be "L" = log item (journal entry), "T" = todo item.', 'talk');
...
REPLACE INTO schemacols (colname, des, tablename) VALUES ('qbid', 'unique id.', 'querybuffer');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('qdigest', 'An MD5sum of the SQL search query.', 'dirsearchres2');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('query', 'The query to be run later.', 'querybuffer');
...
REPLACE INTO schemacols (colname, des, tablename) VALUES ('replycount', 'The number of people that have replied to this entry.', 'log');
...
REPLACE INTO schemacols (colname, des, tablename) VALUES ('sacct', 'type of account:  100, 101, 102, 500, 501, 502.  1xx for credit card, 5xx for 900 number, 00 for $25, 01 for $15, 02 for $5/$5.95', 'ibill_codes');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('security', 'The security level of the post.  "public" is for all, "private" is for only the poster, and "usemask" does a bitwase and of the allowmask and the groupmask of the friend viewing it.', 'log');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('showbydefault', 'Unused.', 'friends');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('sortorder', 'An integer specifying the order the color codes are to be displayed.', 'themecoltypes');
...
REPLACE INTO schemacols (colname, des, tablename) VALUES ('type of account:  100, 101, 102, 500, 50', 'ibill_codes', 'sacct');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('unique code from ibill.com', 'ibill_codes', 'code');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('unique id', 'cmdbuffer', 'cbid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('unique id', 'ibill_codes', 'ibid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('unique id.', 'querybuffer', 'qbid');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('unused.', 'userusage', 'timecheck');
...
REPLACE INTO schemacols (colname, des, tablename) VALUES ('userid', 'The [dbtable[user]] userid of the banner.', 'ban');
...
REPLACE INTO schemacols (colname, des, tablename) VALUES ('userid', '[dbtable[user]]-userid that used the cod', 'ibill_codes');
...
REPLACE INTO schemacols (colname, des, tablename) VALUES ('what', 'What type of hint needs to be purged.  There used to be many hints, but now this is always "hintlastn"', 'batchdelete');
REPLACE INTO schemacols (colname, des, tablename) VALUES ('year', 'The year of the eventtime.  Duplicated for an index.', 'log');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Holds all fixed-length data about comments to journal entries.  Indexes are all on this table.  The actual text is in talktext, and the meta-data is in textprop.', '0', 'off', NULL, 'talk');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Keeps track of what users are banning other users.', '0', 'off', NULL, 'ban');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Place to hold queries to do later in an efficient batch under an explicit table lock.  Currently they\'re done every 10 seconds, but this will be changed to be dependent on the table they\'re being buffered for.  The reason for this is because 2 writes/second is slow on often-read tables, but a batch of 20 or 30 every 10 seconds is very fast, if inside a LOCK TABLES ... UNLOCK TABLES', '0', 'off', NULL, 'querybuffer');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Used for the processing of ibill.com receipts/transactions.  Basically, it\'s a shared secret system... they give us a ton of codes and they give people buying payments those codes over time.  When we run out, we need to ask for more and import them again.', '0', 'off', NULL, 'ibill_codes');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('this table sucks and will die, to be replaced by a new fast and small version.  poorly designed.  mad old.', '0', 'off', NULL, 'logins');
...
UPDATE supportcat SET public_read='1',no_autoreply='0',sortorder='2',is_selectable='1',allow_screened='1',public_help='0',scope='general',basepoints='1',replyaddress=NULL,catname='General/Unknown',hide_helpers='0' WHERE catkey='general';
...
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('char', 'AOL IM ScreenName', '1', 'aolim', 'AOL Instant Messanger', 'general');
...
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('char', 'LJ lang code in ml_langs', '1', 'browselang', 'Language to browse with', 'general');
...
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('char', 'City lived in.', '1', 'city', 'City', 'general');
UPDATE userproplist SET des='City lived in.',prettyname='City',indexed='1',scope='general',datatype='char' WHERE name='city';
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('char', '2 letter country code', '1', 'country', 'Country', 'general');
...
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('char', 'ICQ Number', '1', 'icq', 'ICQ', 'general');
UPDATE userproplist SET des='ICQ Number',prettyname='ICQ',indexed='1',scope='general',datatype='char' WHERE name='icq';
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('char', 'Jabber address (username@server)', '1', 'jabber', 'Jabber Address', 'general');
...
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('char', 'Minimal security for new events; values are: public, private or friends', '0', 'newpost_minsecurity', 'Minimal Security', 'general');
...
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('bool', '0: don\'t get birthday reminder mail, 1: do get birthday reminder mail', '1', 'opt_bdaymail', 'Get Birthday Reminders', 'general');
...
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('bool', '1: don\'t allow robots, 0: do', '1', 'opt_blockrobots', 'Block Robots & Spiders', 'general');
...
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('bool', '0: show friendofs, 1: hide friendofs', '0', 'opt_hidefriendofs', 'Hide Friend-Of List', 'general');
...
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('char', 'N: No, S: some (anonymous), A: all', '1', 'opt_logcommentips', 'Log Comment IPs', 'general');
...
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('', 'Maxium picture height to be shown in journal before being linkitized.  0: for no max', '1', 'opt_maxpicheight', 'Max Picture Height', 'general');
...
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('', 'Maxium picture width to be shown in journal before being linkitized.  0: for no max', '1', 'opt_maxpicwidth', 'Max Picture Width', 'general');
...
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('', 'Maxium word length before forced word breaks.  0: for no max', '1', 'opt_maxwordlength', 'Max Word Length', 'general');
...
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('bool', 'Show number of comments in URL', '0', 'opt_nctalklinks', 'Show number of comments in URL', 'general');
...
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('bool', '1: no forum icons shown, 0: default, show them', '1', 'opt_notalkicons', 'No Forum Icons', 'general');
...
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('char', 'Y: include links to topic directory, N: don\'t.', '1', 'opt_showtopicstuff', 'Topic Directory Integration', 'general');
...
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('num', 'The style ID# of the S1 style for the day view view.', '0', 's1_day_style', 'Day View StyleID', 'general');
...
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('num', 'The style ID# of the S1 style for the friends view page.', '0', 's1_friends_style', 'Friends View StyleID', 'general');
...
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('num', 'The style ID# of the S1 style for the recent entries view.', '0', 's1_lastn_style', 'Recent View StyleID', 'general');
...
INSERT IGNORE INTO userproplist (datatype, des, indexed, name, prettyname, scope) VALUES ('char', 'Yahoo ID', '1', 'yahoo', 'Yahoo ID', 'general');
