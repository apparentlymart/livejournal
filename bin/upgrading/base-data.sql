...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Allows a user to generate unlimited numbers of invite codes.', '1', 'grantperm', 'Grant Permanent Account', 'general');
UPDATE priv_list SET des='Allows a user to generate unlimited numbers of invite codes.',is_public='1',privname='Grant Permanent Account',scope='general' WHERE privcode='grantperm';
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Reset an account\'s current password', '1', 'reset_password', 'Reset User Password', 'general');
UPDATE priv_list SET des='Reset an account\'s current password',is_public='1',privname='Reset User Password',scope='general' WHERE privcode='reset_password';
...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Allows a user to approve screened responses, change request summaries and answer and comment unscreened. arg=Unique Support Category', '1', 'supporthelp', 'Support - Help people', 'general');
UPDATE priv_list SET des='Allows a user to approve screened responses, change request summaries and answer and comment unscreened. arg=Unique Support Category',is_public='1',privname='Support - Help people',scope='general' WHERE privcode='supporthelp';
...
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('0', 'char', 'AOL IM ScreenName', '1', '0', 'aolim', 'AOL Instant Messanger', 'general');
UPDATE userproplist SET cldversion='0',datatype='char',des='AOL IM ScreenName',indexed='1',is_blob='0',prettyname='AOL Instant Messanger',scope='general' WHERE name='aolim';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('0', 'num', 'The ID of the blob cluster user\'s media resides on.', '1', '0', 'blob_clusterid', 'Blob Cluster ID', 'general');
UPDATE userproplist SET cldversion='0',datatype='num',des='The ID of the blob cluster user\'s media resides on.',indexed='1',is_blob='0',prettyname='Blob Cluster ID',scope='general' WHERE name='blob_clusterid';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'LJ lang code in ml_langs', '1', '0', 'browselang', 'Language to browse with', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='LJ lang code in ml_langs',indexed='1',is_blob='0',prettyname='Language to browse with',scope='general' WHERE name='browselang';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'City lived in.', '1', '0', 'city', 'City', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='City lived in.',indexed='1',is_blob='0',prettyname='City',scope='general' WHERE name='city';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', '2 letter country code', '1', '0', 'country', 'Country', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='2 letter country code',indexed='1',is_blob='0',prettyname='Country',scope='general' WHERE name='country';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'bool', 'Used for large communities to prevent loading and displaying the complete list of members', '0', '0', 'dont_load_members', 'Don\'t load membership information', 'general');
UPDATE userproplist SET cldversion='4',datatype='bool',des='Used for large communities to prevent loading and displaying the complete list of members',indexed='0',is_blob='0',prettyname='Don\'t load membership information',scope='general' WHERE name='dont_load_members';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'On each postevent, the dupsig is checked and updated to prevent accidental duplicate posts', '0', '0', 'dupsig_post', 'Duplicate signature for last post', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='On each postevent, the dupsig is checked and updated to prevent accidental duplicate posts',indexed='0',is_blob='0',prettyname='Duplicate signature for last post',scope='general' WHERE name='dupsig_post';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'Comma separated list of email addresses allowed to send mail via gateway', '0', '0', 'emailpost_allowfrom', 'Allowed addresses to post via email', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='Comma separated list of email addresses allowed to send mail via gateway',indexed='0',is_blob='0',prettyname='Allowed addresses to post via email',scope='general' WHERE name='emailpost_allowfrom';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'Numeric or alpha PIN used for posting via email gateway', '0', '0', 'emailpost_pin', 'PIN for email posting', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='Numeric or alpha PIN used for posting via email gateway',indexed='0',is_blob='0',prettyname='PIN for email posting',scope='general' WHERE name='emailpost_pin';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'Base Title of Friends Page', '0', '0', 'friendspagetitle', 'Friends Page Title', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='Base Title of Friends Page',indexed='0',is_blob='0',prettyname='Friends Page Title',scope='general' WHERE name='friendspagetitle';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'M: male, F: female, U: unspecified', '1', '0', 'gender', 'Gender', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='M: male, F: female, U: unspecified',indexed='1',is_blob='0',prettyname='Gender',scope='general' WHERE name='gender';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'How the user heard about LiveJournal', '0', '0', 'howhear', 'How heard about LiveJouranl', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='How the user heard about LiveJournal',indexed='0',is_blob='0',prettyname='How heard about LiveJouranl',scope='general' WHERE name='howhear';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('0', 'char', 'ICQ Number', '1', '0', 'icq', 'ICQ', 'general');
UPDATE userproplist SET cldversion='0',datatype='char',des='ICQ Number',indexed='1',is_blob='0',prettyname='ICQ',scope='general' WHERE name='icq';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('0', 'char', 'Jabber address (username@server)', '1', '0', 'jabber', 'Jabber Address', 'general');
UPDATE userproplist SET cldversion='0',datatype='char',des='Jabber address (username@server)',indexed='1',is_blob='0',prettyname='Jabber Address',scope='general' WHERE name='jabber';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'Domain which will load user\'s journal', '0', '0', 'journaldomain', 'Domain Alias', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='Domain which will load user\'s journal',indexed='0',is_blob='0',prettyname='Domain Alias',scope='general' WHERE name='journaldomain';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'Subtitle of Journal', '0', '0', 'journalsubtitle', 'Journal Subtitle', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='Subtitle of Journal',indexed='0',is_blob='0',prettyname='Journal Subtitle',scope='general' WHERE name='journalsubtitle';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'Base Title of Journal', '0', '0', 'journaltitle', 'Journal Title', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='Base Title of Journal',indexed='0',is_blob='0',prettyname='Journal Title',scope='general' WHERE name='journaltitle';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'Comma separated:  Unix time user agreed to the Terms of Service, revision number', '0', '0', 'legal_tosagree', 'Agreed to Terms of Service', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='Comma separated:  Unix time user agreed to the Terms of Service, revision number',indexed='0',is_blob='0',prettyname='Agreed to Terms of Service',scope='general' WHERE name='legal_tosagree';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'num', 'Encoding in which to mail comments to the user. Defaults to UTF-8.', '0', '0', 'mailencoding', 'Mail Encoding', 'general');
UPDATE userproplist SET cldversion='4',datatype='num',des='Encoding in which to mail comments to the user. Defaults to UTF-8.',indexed='0',is_blob='0',prettyname='Mail Encoding',scope='general' WHERE name='mailencoding';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'bool', '1: This community is moderated', '0', '0', 'moderated', 'Moderation status', 'general');
UPDATE userproplist SET cldversion='4',datatype='bool',des='1: This community is moderated',indexed='0',is_blob='0',prettyname='Moderation status',scope='general' WHERE name='moderated';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('0', 'char', 'MSN Username', '1', '0', 'msn', 'MSN Username', 'general');
UPDATE userproplist SET cldversion='0',datatype='char',des='MSN Username',indexed='1',is_blob='0',prettyname='MSN Username',scope='general' WHERE name='msn';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'Time (user-side) of the user\'s last entry in their personal journal', '0', '0', 'newesteventtime', 'Newest event time', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='Time (user-side) of the user\'s last entry in their personal journal',indexed='0',is_blob='0',prettyname='Newest event time',scope='general' WHERE name='newesteventtime';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'Minimal security for new events; values are: public, private or friends', '0', '0', 'newpost_minsecurity', 'Minimal Security', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='Minimal security for new events; values are: public, private or friends',indexed='0',is_blob='0',prettyname='Minimal Security',scope='general' WHERE name='newpost_minsecurity';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'bool', 'True if this community allows non-member posting access', '0', '0', 'nonmember_posting', 'Non-Member posting access', 'general');
UPDATE userproplist SET cldversion='4',datatype='bool',des='True if this community allows non-member posting access',indexed='0',is_blob='0',prettyname='Non-Member posting access',scope='general' WHERE name='nonmember_posting';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('0', 'bool', '0: don\'t get birthday reminder mail, 1: do get birthday reminder mail', '1', '0', 'opt_bdaymail', 'Get Birthday Reminders', 'general');
UPDATE userproplist SET cldversion='0',datatype='bool',des='0: don\'t get birthday reminder mail, 1: do get birthday reminder mail',indexed='1',is_blob='0',prettyname='Get Birthday Reminders',scope='general' WHERE name='opt_bdaymail';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'bool', '1: don\'t allow robots, 0: do', '1', '0', 'opt_blockrobots', 'Block Robots & Spiders', 'general');
UPDATE userproplist SET cldversion='4',datatype='bool',des='1: don\'t allow robots, 0: do',indexed='1',is_blob='0',prettyname='Block Robots & Spiders',scope='general' WHERE name='opt_blockrobots';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'bool', '0: show friendofs, 1: hide friendofs', '0', '0', 'opt_hidefriendofs', 'Hide Friend-Of List', 'general');
UPDATE userproplist SET cldversion='4',datatype='bool',des='0: show friendofs, 1: hide friendofs',indexed='0',is_blob='0',prettyname='Hide Friend-Of List',scope='general' WHERE name='opt_hidefriendofs';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'N: No, S: some (anonymous), A: all', '1', '0', 'opt_logcommentips', 'Log Comment IPs', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='N: No, S: some (anonymous), A: all',indexed='1',is_blob='0',prettyname='Log Comment IPs',scope='general' WHERE name='opt_logcommentips';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', '', 'Maxium picture height to be shown in journal before being linkitized.  0: for no max', '1', '0', 'opt_maxpicheight', 'Max Picture Height', 'general');
UPDATE userproplist SET cldversion='4',datatype='',des='Maxium picture height to be shown in journal before being linkitized.  0: for no max',indexed='1',is_blob='0',prettyname='Max Picture Height',scope='general' WHERE name='opt_maxpicheight';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', '', 'Maxium picture width to be shown in journal before being linkitized.  0: for no max', '1', '0', 'opt_maxpicwidth', 'Max Picture Width', 'general');
UPDATE userproplist SET cldversion='4',datatype='',des='Maxium picture width to be shown in journal before being linkitized.  0: for no max',indexed='1',is_blob='0',prettyname='Max Picture Width',scope='general' WHERE name='opt_maxpicwidth';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('0', '', 'Maxium word length before forced word breaks.  0: for no max', '1', '0', 'opt_maxwordlength', 'Max Word Length', 'general');
UPDATE userproplist SET cldversion='0',datatype='',des='Maxium word length before forced word breaks.  0: for no max',indexed='1',is_blob='0',prettyname='Max Word Length',scope='general' WHERE name='opt_maxwordlength';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'bool', 'Show number of comments in URL', '0', '0', 'opt_nctalklinks', 'Show number of comments in URL', 'general');
UPDATE userproplist SET cldversion='4',datatype='bool',des='Show number of comments in URL',indexed='0',is_blob='0',prettyname='Show number of comments in URL',scope='general' WHERE name='opt_nctalklinks';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'bool', '1: no forum icons shown, 0: default, show them', '1', '0', 'opt_notalkicons', 'No Forum Icons', 'general');
UPDATE userproplist SET cldversion='4',datatype='bool',des='1: no forum icons shown, 0: default, show them',indexed='1',is_blob='0',prettyname='No Forum Icons',scope='general' WHERE name='opt_notalkicons';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('0', 'char', 'Y: include links to topic directory, N: don\'t.', '1', '0', 'opt_showtopicstuff', 'Topic Directory Integration', 'general');
UPDATE userproplist SET cldversion='0',datatype='char',des='Y: include links to topic directory, N: don\'t.',indexed='1',is_blob='0',prettyname='Topic Directory Integration',scope='general' WHERE name='opt_showtopicstuff';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'bool', '1: use journal style when commenting on other journals from friends page', '0', '0', 'opt_stylemine', 'Style=Mine', 'general');
UPDATE userproplist SET cldversion='4',datatype='bool',des='1: use journal style when commenting on other journals from friends page',indexed='0',is_blob='0',prettyname='Style=Mine',scope='general' WHERE name='opt_stylemine';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'bool', '1: friends view uses shared pictures, 0: uses poster\'s picture', '1', '0', 'opt_usesharedpic', 'Use Shared Journal Pic', 'general');
UPDATE userproplist SET cldversion='4',datatype='bool',des='1: friends view uses shared pictures, 0: uses poster\'s picture',indexed='1',is_blob='0',prettyname='Use Shared Journal Pic',scope='general' WHERE name='opt_usesharedpic';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', '1: ping weblogs.com with updates', '0', '0', 'opt_weblogscom', 'Ping Weblogs.com', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='1: ping weblogs.com with updates',indexed='0',is_blob='0',prettyname='Ping Weblogs.com',scope='general' WHERE name='opt_weblogscom';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'N: none, A: actual, L: livejournal, B: both', '1', '0', 'opt_whatemailshow', 'Which email address to display', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='N: none, A: actual, L: livejournal, B: both',indexed='1',is_blob='0',prettyname='Which email address to display',scope='general' WHERE name='opt_whatemailshow';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'Screen new comments: A=All, N=None, F=from non-Friends, R=from non-users', '0', '0', 'opt_whoscreened', 'Screening comments', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='Screen new comments: A=All, N=None, F=from non-Friends, R=from non-users',indexed='0',is_blob='0',prettyname='Screening comments',scope='general' WHERE name='opt_whoscreened';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'Username of other journal to redirect to, if u.statusvis==\"R\"', '1', '0', 'renamedto', 'Redirect to other account', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='Username of other journal to redirect to, if u.statusvis==\"R\"',indexed='1',is_blob='0',prettyname='Redirect to other account',scope='general' WHERE name='renamedto';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'Keep track of syncitems lastupdate value & time for last two getevent+syncitems requests, checking for loops from broken clients.', '0', '0', 'rl_syncitems_getevents_loop', 'Prevent loops in syncitems getevents', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='Keep track of syncitems lastupdate value & time for last two getevent+syncitems requests, checking for loops from broken clients.',indexed='0',is_blob='0',prettyname='Prevent loops in syncitems getevents',scope='general' WHERE name='rl_syncitems_getevents_loop';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'Records the error message when RSS parsing fails', '0', '0', 'rssparseerror', 'Syndication Parse Error', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='Records the error message when RSS parsing fails',indexed='0',is_blob='0',prettyname='Syndication Parse Error',scope='general' WHERE name='rssparseerror';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'num', 'The style ID# of the S1 style for the calendar view.', '0', '0', 's1_calendar_style', 'Calendar View StyleID', 'general');
UPDATE userproplist SET cldversion='4',datatype='num',des='The style ID# of the S1 style for the calendar view.',indexed='0',is_blob='0',prettyname='Calendar View StyleID',scope='general' WHERE name='s1_calendar_style';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'num', 'The style ID# of the S1 style for the day view view.', '0', '0', 's1_day_style', 'Day View StyleID', 'general');
UPDATE userproplist SET cldversion='4',datatype='num',des='The style ID# of the S1 style for the day view view.',indexed='0',is_blob='0',prettyname='Day View StyleID',scope='general' WHERE name='s1_day_style';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'num', 'The style ID# of the S1 style for the friends view page.', '0', '0', 's1_friends_style', 'Friends View StyleID', 'general');
UPDATE userproplist SET cldversion='4',datatype='num',des='The style ID# of the S1 style for the friends view page.',indexed='0',is_blob='0',prettyname='Friends View StyleID',scope='general' WHERE name='s1_friends_style';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'num', 'The style ID# of the S1 style for the recent entries view.', '0', '0', 's1_lastn_style', 'Recent View StyleID', 'general');
UPDATE userproplist SET cldversion='4',datatype='num',des='The style ID# of the S1 style for the recent entries view.',indexed='0',is_blob='0',prettyname='Recent View StyleID',scope='general' WHERE name='s1_lastn_style';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'num', 'S2 Styleid to use', '0', '0', 's2_style', 'S2 Style', 'general');
UPDATE userproplist SET cldversion='4',datatype='num',des='S2 Styleid to use',indexed='0',is_blob='0',prettyname='S2 Style',scope='general' WHERE name='s2_style';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'BML scheme name', '0', '0', 'schemepref', 'BML Scheme Preference', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='BML scheme name',indexed='0',is_blob='0',prettyname='BML Scheme Preference',scope='general' WHERE name='schemepref';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('0', 'char', 'Index to speed directory searches.  Only present if opt_infoshow=Y', '1', '0', 'sidx_bdate', 'SearchIndex: Birthdate', 'general');
UPDATE userproplist SET cldversion='0',datatype='char',des='Index to speed directory searches.  Only present if opt_infoshow=Y',indexed='1',is_blob='0',prettyname='SearchIndex: Birthdate',scope='general' WHERE name='sidx_bdate';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('0', 'char', 'Index to speed directory searches.  Format %2s-%s-%s (iso country code, state, city).  Only present if opt_infoshow=Y', '1', '0', 'sidx_loc', 'SearchIndex: Location', 'general');
UPDATE userproplist SET cldversion='0',datatype='char',des='Index to speed directory searches.  Format %2s-%s-%s (iso country code, state, city).  Only present if opt_infoshow=Y',indexed='1',is_blob='0',prettyname='SearchIndex: Location',scope='general' WHERE name='sidx_loc';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', '2 letter state code, or full state name', '1', '0', 'state', 'State', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='2 letter state code, or full state name',indexed='1',is_blob='0',prettyname='State',scope='general' WHERE name='state';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'num', '\'1\' for S1 or \'2\' for S2.  Undefined means site default.', '0', '0', 'stylesys', 'Style System to use', 'general');
UPDATE userproplist SET cldversion='4',datatype='num',des='\'1\' for S1 or \'2\' for S2.  Undefined means site default.',indexed='0',is_blob='0',prettyname='Style System to use',scope='general' WHERE name='stylesys';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'URL of website', '0', '0', 'url', 'Website Address', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='URL of website',indexed='0',is_blob='0',prettyname='Website Address',scope='general' WHERE name='url';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', 'Name of website', '0', '0', 'urlname', 'Website Name', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='Name of website',indexed='0',is_blob='0',prettyname='Website Name',scope='general' WHERE name='urlname';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('0', 'char', 'Yahoo ID', '1', '0', 'yahoo', 'Yahoo ID', 'general');
UPDATE userproplist SET cldversion='0',datatype='char',des='Yahoo ID',indexed='1',is_blob='0',prettyname='Yahoo ID',scope='general' WHERE name='yahoo';
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, is_blob, name, prettyname, scope) VALUES ('4', 'char', '5 digit zip code (if in US)', '1', '0', 'zip', 'ZIP code', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='5 digit zip code (if in US)',indexed='1',is_blob='0',prettyname='ZIP code',scope='general' WHERE name='zip';
