...
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, multihomed, name, prettyname, scope) VALUES ('4', 'num', 'Unix time at which site scheme has been explicitly set by the user', '0', '0', 'scheme_manually_set', 'Explicit Scheme', 'general');
UPDATE userproplist SET cldversion='4',datatype='num',des='Unix time at which site scheme has been explicitly set by the user',indexed='0',multihomed='0',prettyname='Explicit Scheme',scope='general' WHERE name='scheme_manually_set';
...
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, multihomed, name, prettyname, scope) VALUES ('4', 'char', 'Default expanded state of ESN inbox items', '0', '0', 'esn_inbox_default_expand', 'Default ESN inbox expanded state', 'general');
UPDATE userproplist SET cldversion='4',datatype='char',des='Default expanded state of ESN inbox items',indexed='0',multihomed='0',prettyname='Default ESN inbox expanded state',scope='general' WHERE name='esn_inbox_default_expand';
