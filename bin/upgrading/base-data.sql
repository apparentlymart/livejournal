...
INSERT IGNORE INTO userproplist (cldversion, datatype, des, indexed, multihomed, name, prettyname, scope) VALUES ('4', 'num', 'Notification limit per post per day by SMS', '0', '0', 'sms_perpost_notif_limit', 'SMS notification limit per post per day', 'general');
UPDATE userproplist SET cldversion='4',datatype='num',des='Notification limit per post per day by SMS',indexed='0',multihomed='0',prettyname='SMS notification limit per post per day',scope='general' WHERE name='sms_perpost_notif_limit';
