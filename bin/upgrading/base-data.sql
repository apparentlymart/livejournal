...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('A clustered table where a bunch of actions that have happened are logged, like a post action (which calls LJ::note_recent_action).', '0', 'off', NULL, 'recentactions');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('A global table which logs summaries on results of cluster sweeps by cron. The cron job is usually run nightly, to clean the caches, so in turn this table is updated nightly.', '0', 'off', NULL, 'actionhistory');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Categories under which Frequently Asked Questions can be classified.', '1', 'off', NULL, 'faqcat');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Challenges table (for non-memcached support), for RFC 2617 challenge-response digest authentication support; used on-site for logins, commenting, etc.', '0', 'off', NULL, 'challenges');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered friend groups. Stores data on user custom friend groups.', '0', 'off', NULL, 'friendgroup2');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered memories table. Stores metadata for entries users mark as \"Memories\".', '0', 'off', NULL, 'memorable2');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered memory keyword map.', '0', 'off', NULL, 'memkeyword2');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered table (compdata is gzipped). This table is keyed on (userid, layerid) and contains data that is compressed when it\'s put in. (Tests show this reduces data size by about 75 percent.) \n\r\nOnly for user S2 layers (not system) and is lazily migrated. New saves go here. Loads try this table first (unless user is system) and if miss, then try the [dbtable[s2compiled]] table on the global.', '0', 'off', NULL, 's2compiled2');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered table, for tracking blobs (binary large objects) of on-disk data. \n\r\nThe user counter type \"B\" is available for tracking blobids. Blob* files/classes for storing Blobs need to be added either to a local path or a remote Blob server (\"remote Blob server\" support has since been removed in favor of MogileFS). \r\n\r\nNotes: blobids aren\'t necessarily unique between domains; global userpicids may collide with the counter used for the rest.  So, the type must be in the key. domain IDs are set up in ljconfig.pl.', '0', 'off', NULL, 'userblob');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered table, holding unixtime of the user\'s next birthday.', '0', 'off', NULL, 'birthdays');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered table. From data version 7, userpics are clustered - see also [dbtable[userpicmap2]]. A site-configurable limit to the number of keywords ([dbtable[userkeywords]]) for each userpic exists; default is 5. \n\r\nThe global [dbtable[userpic]] table is used prior to data version 7.', '0', 'off', NULL, 'userpic2');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered table. Stores data for mapping userpic keywords ([dbtable[userkeywords]]) to userpics ([dbtable[userpic2]]). From data version 7, userpics are clustered.', '0', 'off', NULL, 'userpicmap2');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered table. Stores user S1 style system override customizations. The clustered table was used from data version 5. Please see also the global [dbtable[overrides]] table.', '0', 'off', NULL, 's1overrides');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered table. Temporary IP storage for spam reports, whether the journal in which the anonymous comment was posted in has enabled IP tracking or not. Used with the [dbtable[spamreports]] table. \n\r\nFor the anonymous comment, LJ::record_anon_comment_ip gets the IP and records it into the this table. It is cleaned by an ljmaint script. \r\n\r\nNote: These IPs are only stored for 5 days - so anonymous comments deleted after 5 days are fairly useless, and reports about them are quietly discarded by the comment deletion system.', '0', 'off', NULL, 'tempanonips');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered table. Tracks special links (\"reluser relationships\") between accounts.  \n\r\nRelationship type IDs are defined in the LJ::get_reluser_id function. A relationship \"typeid\" cannot be a single character. Please see also [dbtable[reluser]].', '0', 'off', NULL, 'reluser2');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered table. User style data for S1 style system. The clustered table was used from data version 5. Please see also the global [dbtable[style]] table.', '0', 'off', NULL, 's1style');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered table.', '0', 'off', NULL, 's2stylelayers2');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered userpic keywords. See also [dbtable[userpic2]]/[dbtable[userpicmap2]] \n\r\nThe userkeywords table never gets deleted from, except if the user itself gets deleted.', '0', 'off', NULL, 'userkeywords');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered version of querybuffer table (which no longer exists). Uses specialized commands instead of general table locking.', '0', 'off', NULL, 'cmdbuffer');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered. This table was introduced to support user properties greater than 255 bytes.', '0', 'off', NULL, 'userpropblob');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered.', '0', 'off', NULL, 'sms_msg');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered.', '0', 'off', NULL, 'sms_msgack');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered.', '0', 'off', NULL, 'sms_msgerror');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered.', '0', 'off', NULL, 'sms_msgprop');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered.', '0', 'off', NULL, 'sms_msgtext');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered.', '0', 'off', NULL, 'usermsg');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered.', '0', 'off', NULL, 'usermsgprop');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered.', '0', 'off', NULL, 'usermsgtext');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Community interests. Please see also [dbtable[interests]], which stores interest data for normal [dbtable[user]] accounts.', '0', 'off', NULL, 'comminterests');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Contextual product prodding history. This makes sure people are not pestered by specific prodding when they do not want it anymore.', '0', 'off', NULL, 'cprod');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Data for SiteMessages widget (used to post announcements to users). ', '0', 'off', NULL, 'site_messages');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Data for a rotating secret value on the server, for auth support.', '0', 'off', NULL, 'secrets');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Data for the Question of the Day (\"Writer\'s Block\") widget.', '0', 'off', NULL, 'qotd');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('ESN event queue notification method.', '0', 'off', NULL, 'notifyqueue');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('External user mappings. Note: extuser/extuserid are expected to sometimes be NULL, even though they are keyed. (Null values are not taken into account when using indexes).', '0', 'off', NULL, 'extuser');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('For LiveJournal installations with many databases, the database connection info, roles, and weightings can be stored in the database instead of the %LJ::DBINFO hash, for easier (web-based) management.', '0', 'off', NULL, 'dbinfo');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Global table (compdata is not gzipped). Please see also [dbtable[s2compiled2]].', '0', 'off', NULL, 's2compiled');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Global table. Stores user S1 style system override customizations. Please see also the [dbtable[s1overrides]] clustered table.', '0', 'off', NULL, 'overrides');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Global table. Stores userpic keywords. Please see also the clustered [dbtable[userkeywords]] table, used from data version 7.', '0', 'off', NULL, 'keywords');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Global table. The \"talk_max_urls\" site  variable, when set, enables logging of a given number of URLs from new comments here.', '0', 'off', NULL, 'commenturls');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Global table. Used for the spam reporting system, with the [dbtable[tempanonips]] table. When deleting a comment, users have the option to \"mark comment as spam.\" When checked, the comment is saved here for administrator review. \n\r\nThe admin tool (/admin/spamreports.bml hinging on siteadmin:spamreports) allows spam report viewing: top 10 reported IPs, top 10 reported users (and showing if someone has received a spam warning before), last 10 reports, reports in last 1 hour, 6 hours, and 24 hours. Admins can then take whatever action they think is necessary and close the report (page supports sorting by open/closed).\r\n\r\nThe LJ::mark_comment_as_spam function copies the comment reported as spam into this table. The LJ::mark_entry_as_spam function parallels it, copying a community entry marked as spam into the table. \r\n\r\nIf the comment was anonymous, the LJ::record_anon_comment_ip function will get the IP and record it into the [dbtable[tempanonips]] table. An ljmaint script cron task cleans out data older than 90 days. \r\n\r\nThe \'spamreport_notification\' hook exists for optionally notifying people about spamming.', '0', 'off', NULL, 'spamreports');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Global table. User style data for S1 style system. Please see also the [dbtable[s1style]] clustered table.', '0', 'off', NULL, 'style');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Global table. Userpic storage. Please see also [dbtable[userpicmap]]. For sites using data version 7 or greater, the clustered [dbtable[userpic2]] table is used.', '0', 'off', NULL, 'userpic');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Global. Contextual product prodding (\"Hey, you\'ve never used polls, wanna learn how?\").', '0', 'off', NULL, 'cprodlist');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Global. Maps a pollid to a userid.', '0', 'off', NULL, 'pollowner');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Global. Tracks user account transitions (e.g. \"free\" to \"plus\", or whatever site-specific capability classes exist). The time, type, and before => after values are noted in the table.', '0', 'off', NULL, 'usertrans');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Global.', '0', 'off', NULL, 'eventtypelist');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Global.', '0', 'off', NULL, 'notifytypelist');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Global.', '0', 'off', NULL, 'smsuniqmap');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Global.', '0', 'off', NULL, 'smsusermap');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Holds Frequently Asked Question information and their optional summaries for the FAQ section of the support system. Alternate text can be loaded for the questions if available.', '0', 'off', NULL, 'faq');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Holds data for site pages tagged using the htdocs/admin/navtag.bml tool. Siteadmins can tag any URL. The tag itself is lowercase UTF-8. Some are recognized as special (FAQs, user profile pages, etc.), and users can then search by tag.', '0', 'off', NULL, 'navtag');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Holds data for the Support system.  \n\r\nIt is indexed by state, requserid, and reqemail, to let users with the supporthelp priv see past support requests by a user: When viewing a support request, the user with the priv will history.bml, which will then pull up a list of all requests opened by that user or by that e-mail address.', '0', 'off', NULL, 'support');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Holds data for which support tickets a user responded to. Aids in making the Support system \"You Replied\" query fast.', '0', 'off', NULL, 'support_youreplied');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Holds data on user Support points. Used for speedier querying for htdocs/support/highscores.bml.', '0', 'off', NULL, 'supportpointsum');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Holds stock answers for Support system. Answers are viewable by those with the \"supporthelp\" priv, and editable by people who have the ability to grant privileges in their category.', '0', 'off', NULL, 'support_answers');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Holds user e-mail addresses, which were historically stored in the the [dbtable[user]] table.', '0', 'off', NULL, 'email');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Holds user login passwords, which were historically stored in the [dbtable[user]] table.', '0', 'off', NULL, 'password');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Indexed by year, month, day, hour, to allow multiple rows per clusterid, per hour. Only used if MemCache servers are available. Please see also [dbtable[active_user]].', '0', 'off', NULL, 'active_user_summary');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Information for Directory Search: userid, a \"pack\" of information - time of last update, age, journal type, country, state, and city; row modification time, and expiry information.', '0', 'off', NULL, 'usersearch_packdata');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Keeps track of valid invite codes and who has used them. The acctinvite table stores the data on why they were made.', '0', 'off', NULL, 'acctcode');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Like [dbtable[logtags]], but only for the most recent 100 tags-to-entry.', '0', 'off', NULL, 'logtagsrecent');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Mapping for external identity types, like \"O\" - OpenID, \"T\" - TypeKey, etc. \n\r\nThis focuses on OpenID consumer support, and was introduced so infrastructure was in place to make it completely identity-system neutral rather than OpenID-specific. \r\n\r\nIn theory, eventually, this will allow people to log in with TypeKey, LID, etc.', '0', 'off', NULL, 'identitymap');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Mapping of tags applied to an entry.', '0', 'off', NULL, 'logtags');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Memory keyword map. Please see also [dbtable[memkeyword2]].', '0', 'off', NULL, 'memkeyword');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Moderated community post Storable object (all props/options).', '0', 'off', NULL, 'modblob');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Moderated community post summary information.', '0', 'off', NULL, 'modlog');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Obsolete table. It was used to keep track of user activity, such as latest time a user posted in a week, for a given week. Used from data version 3, but ceased to be used later, when the Friends view algorithm was re-designed.', '0', 'off', NULL, 'weekuserusage');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('On posting an entry (public, to personal journal, and not opted out (using latest_optout option at the console)) a user may end up with a row in this table. The htdocs/random.bml page returns a random user that is both 1) publicly listed in the directory, and 2) updated within the past 24 hours. If a user changes their privacy setting, using the console, to not be in this table, it will take up to 24 hours for them to be removed from the random.bml listing; a cron job builds/cleans the table. \n\r\nThe information row is kept for seven days by default. Site administrators can adjust this using the $LJ::RANDOM_USER_PERIOD variable.', '0', 'off', NULL, 'random_user_set');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Partialstats - stores calculation times.', '0', 'off', NULL, 'partialstats');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Partialstats - stores data per cluster.', '0', 'off', NULL, 'partialstatsdata');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Partitioned: ESN subscriptions:  details of a user\'s subscriptions.', '0', 'off', NULL, 'subs');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Partitioned: ESN subscriptions:  metadata on a user\'s subscriptions.', '0', 'off', NULL, 'subsprop');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Partitioned: ESN subscriptions: A flag on event target (a journal) is written here saying whether there are known listeners out there.', '0', 'off', NULL, 'has_subs');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Please see also clustered table, called [dbtable[s2stylelayers2]] on the user clusters.', '0', 'off', NULL, 's2stylelayers');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Required table for moveucluster script, which moves a LiveJournal user between database clusters. Start/completion of the user move is stored in the table. It is also noted in the table if the user is to be expunged; a note is made in the [dbtable[expunged_users]] table that the user and its data has been expunged.', '0', 'off', NULL, 'clustermove');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Required table for user-mover script (ljumover). The script performs mass user-move operations between various clusters.', '0', 'off', NULL, 'clustermove_inprogress');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Stored data for old \'1.0\' version of the Portal; used before the Portal was re-designed.', '0', 'off', NULL, 'portal');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Stores CAPTCHAs.', '0', 'off', NULL, 'captchas');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Stores MogileFS sethandles for the Directory Search.', '0', 'off', NULL, 'dirmogsethandles');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Stores comments, such as OpenID comments, awaiting user approval.', '0', 'off', NULL, 'pendcomments');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Stores community invitations received.', '0', 'off', NULL, 'inviterecv');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Stores community invitations sent.', '0', 'off', NULL, 'invitesent');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Stores data for links users place in their Links List (“blogroll”), used in S2 styles.', '0', 'off', NULL, 'links');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Stores data for mapping userpic [dbtable[keywords]] to [dbtable[userpic]]s. Please see also [dbtable[userpicmap2]].', '0', 'off', NULL, 'userpicmap');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Stores data to give users access to view their logins in the past 30 days, if they\'re at all afraid that their account has been compromised ', '0', 'off', NULL, 'loginlog');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Stores flagged content meta-data. Content can be flagged as adult content, etc.', '0', 'off', NULL, 'content_flag');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Summary counts for security on entry keywords (tags).', '0', 'off', NULL, 'logkwsum');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Table describing a user\'s friends groups. Friends groups are used to restrict who can see an individual entry, or to filter the friends view.', '0', 'off', NULL, 'friendgroup');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Table describing the different interests listed, and the number of users listing each interest. Please see also [dbtable[comminterests]].', '0', 'off', NULL, 'interests');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Table showing what tags a user has; parentkwid can be null.', '0', 'off', NULL, 'usertags');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('The [dbtable[dbinfo]] table keeps track of which databases exist. This one keeps track of each database\'s roles and weights.', '0', 'off', NULL, 'dbweights');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('The moveucluster script logs here on expunging a user, so they can be queried later by time or username.', '0', 'off', NULL, 'expunged_users');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Tracks open HTTP proxies.', '0', 'off', NULL, 'openproxy');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Tracks per-user backup status.', '0', 'off', NULL, 'backupdirty');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Tracks special links (\"reluser relationships\") between accounts, such as community maintainers/moderators. A relationship \"type\" is a single character. \n\r\nIt is a non-clustered global table. Please see also [dbtable[reluser2]].', '0', 'off', NULL, 'reluser');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Unlike most other *proplist tables, this one is auto-populated by the LiveJournal application.', '0', 'off', NULL, 'sms_msgproplist');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Unlike most other *proplist tables, this one is auto-populated by the LiveJournal application.', '0', 'off', NULL, 'subsproplist');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Used by the move user cluster script. Both before and after updating a user\'s read-only flag we add the user to this table, which is just an index onto users who - might - be in read-only. \n\r\nA maintenance task will periodically clean those and make sure nobody is stranded in read-only, without resorting to a full tablescan of the [dbtable[user]] table, by checking if users are still locked, removing those that are not from this table, querying the job server (if up) for users that are still locked and unlocking those that can be unlocked.', '0', 'off', NULL, 'readonly_user');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Used for tracking where users are active; for per-activity user cluster statistics. The LJ::make_user_active function updates into this table, so long as it has not already been updated for the same user within the last hour. For sites not using memcached, the table is always updated. Please see also [dbtable[active_user]].', '0', 'off', NULL, 'clustertrack2');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Used for tracking, such as tracking types of user activity on a per-hour basis (example: $u had login activity during this hour). An \"active user\" is a user who has hit a LiveJournal page while logged-in, within the specified time period. Only used if MemCache servers are available, and the site administrator has not disabled active user tracking in ljconfig.pl. Clustered activity data from the current or previous hour is not harvested, to avoid counting duplicates. The year, month, day, hour, and userid columns make up the primary key, for duplicate checking. Please see also [dbtable[active_user_summary]] and [dbtable[clustertrack2]].', '0', 'off', NULL, 'active_user');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Useful for general purpose status logging, such as when an entry is deleted or logging post-by-e-mail activity. \n\r\nThe table stores the initiator of the event so that we are able to look back and say, for example: \"this person deleted the entry\". This works for communities and individual journals and the actions are logged on the account that lost the entry. \r\n\r\nThe basic format is [ action, actiontarget ]. An action is just a textual description of what happened (up to 30 characters) and the target is optional but is likely some numeric value.', '0', 'off', NULL, 'userlog');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('User counters on the global (contrary to the name).', '0', 'off', NULL, 'usercounter');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('User counters. Deprecated and should not be used for any purpose. Use [dbtable[usercounter]] instead.', '0', 'off', NULL, 'counter');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Web sessions.  Optionally tied to IPs and with expiration times. Whenever a session is okayed, expired ones or ones created over 30 days ago are deleted. \n\r\nA live session can\'t change e-mail address or password. Digest authentication will be required for that, or JavaScript MD5 challenge-response.', '0', 'off', NULL, 'sessions');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Worker(s) result storage.', '0', 'off', NULL, 'jobstatus');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('ZIP Code data for the United States that includes geographic co-ordinates. Only used with an ljmaint script that generates marker files for use in making Xplanet maps. Most of the LJ code uses the [dbtable[zip]] table instead.', '0', 'off', NULL, 'zips');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('ZIP Code table used to validate and auto-complete user-entered location data. More information can be found in the (redundant) table [dbtable[zips]], which was imported later.', '0', 'off', NULL, 'zip');
