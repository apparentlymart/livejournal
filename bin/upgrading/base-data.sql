...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered. Stores S1 style system user style data. This - clustered - table was used from data version 5. Please see also the global [dbtable[style]] table.', '0', 'off', NULL, 's1style');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered. Stores SMS errors if they exist.', '0', 'off', NULL, 'sms_msgerror');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered. Stores cached Storable-frozen pre-cleaned S1 user-related style data: overrides and colors.', '0', 'off', NULL, 's1usercache');
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered. Stores cached Storable-frozen pre-cleaned style variables.', '0', 'off', NULL, 's1stylecache');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered. Stores log of SMS message data.', '0', 'off', NULL, 'sms_msg');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered. Stores the acknowledgments received for a given message.', '0', 'off', NULL, 'sms_msgack');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered. Stores the raw and decoded SMS text content.', '0', 'off', NULL, 'sms_msgtext');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered. Stores user S1 style system override customizations. This - clustered - table was used from data version 5. Please see also the global [dbtable[overrides]] table.', '0', 'off', NULL, 's1overrides');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Clustered.', '0', 'off', NULL, 'user_schools');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Global. Stores S1 style system user style data. Please see also the clustered [dbtable[s1style]] table.', '0', 'off', NULL, 'style');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Global. Stores data for mapping remote-party msg unique ids to our userid/msgid tuples; similar to [dbtable[smsusermap]].', '0', 'off', NULL, 'smsuniqmap');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Global. Stores list of possible metadata for SMS messages. Unlike most other *proplist tables, this one is auto-populated by the LiveJournal application.', '0', 'off', NULL, 'sms_msgproplist');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Global. Stores list of the system colors themes available to users.', '0', 'replace', NULL, 'themedata');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Global. Stores userpic metadata. For sites using data version 7 or greater, the clustered [dbtable[userpic2]] table is used. Please see also [dbtable[userpicmap]] and [dbtable[keywords]].', '0', 'off', NULL, 'userpic');
...
REPLACE INTO schematables (des, public_browsable, redist_mode, redist_where, tablename) VALUES ('Stores data for mapping of userid <=> (SMS) number.', '0', 'off', NULL, 'smsusermap');
