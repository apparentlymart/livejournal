...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Allows a user to view data in the \"statushistory\" table for all users. If arg is \"*\", can query by adminid also. arg=Optional \"*\", which allows extended queries.', '1', 'historyview', 'View statushistory info', 'general');
UPDATE priv_list SET des='Allows a user to view data in the \"statushistory\" table for all users. If arg is \"*\", can query by adminid also. arg=Optional \"*\", which allows extended queries.',is_public='1',privname='View statushistory info',scope='general' WHERE privcode='historyview';
